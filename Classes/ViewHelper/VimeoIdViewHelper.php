...
/**
 * Provides a fluid ViewHelper that parses a Vimeo URL and returns the video id.
 */
class VimeoIdViewHelper extends AbstractViewHelper
{
    /**
     * @var string
     */
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument(self::ARGUMENT_URL, 'string', 'A vimeo url');
    }
    ...
    public function render(): string
    {
        ...
        /* If the url is empty */
        if (empty($this->arguments[self::ARGUMENT_URL])) {
        ...
        return $vimeo->parseVideoId($data);
    }
}
